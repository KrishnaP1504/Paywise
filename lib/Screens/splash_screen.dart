...
class _SplashScreenState extends State<SplashScreen>
  ...
  Future<void> _startAnimationSequence() async {
    ...
    // Responsive completion time (~1.1s total)
...
class _FloatingParticle extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final rng = Random(index * 42 + 7);
    final baseX = (rng.nextDouble() * 0.85 + 0.05) * size.width;
    final baseY = (rng.nextDouble() * 0.85 + 0.05) * size.height;
    final dotSize = 3.5 + rng.nextDouble() * 4.5;
    final amplitude = 12.0 + rng.nextDouble() * 16;
