    ...
    try {
      ...
      if (user != null && mounted) {
        ...
        UndoToastManager.showSuccessToast(
          context: context,
          title: "Welcome Back! 👋",
          subtitle: "Signed in as ${user.displayName ?? user.email ?? 'User'}.",
        );
        ...
        return StatefulBuilder(
          builder: (context, setDialogState) => GlassAlertDialog(
            icon: Container(
              ...
              child: const Icon(Icons.lock_reset_rounded, size: 34, color: Color(0xFF3B4CCA)),
            ),
                      ...
                      onPressed: isResetting
                          ...
                          : () async {
                              ...
                              try {
                                ...
                                // Suppress user-not-found to prevent user enumeration
                              ...
                              if (context.mounted) {
                                UndoToastManager.showSuccessToast(
                                  ...
                                  subtitle: "If an account exists, check your inbox for instructions.",
                                );
                              }
                            },
                      child: isResetting
                          ...
                          GestureDetector(
                            ...
                            child: const Row(
                              children: [
                                ...
                                SizedBox(width: 3),
                                Icon(Icons.arrow_forward_rounded, size: 14, color: Color(0xFF3B4CCA)),
                              ],
                            ),
                          ),
                        ],
